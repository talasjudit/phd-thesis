...
\caption{Tapetum-derived sRNAs shape metylation in the germline of \textit{Arabidopsis}}
...
The columella in the root tip of \textit{Arabidopsis} is hypermethylated in the CHH context \cite{RN261}, the root tip was imaged to screen and select the best lines selected for further imaging (Figure\ref{fig:Pol4_5_roots}).
...
\caption{\textbf{The distribution of the abundance of 24nt sRNAs at CLSY associated loci compared between the meiocyte and sperm cell}}
...
\caption{\textbf{The distribution of the abundance of 24nt sRNAs overlapping genomic features of interest, compared between the pollen and sperm cell}}
